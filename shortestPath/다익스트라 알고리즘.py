'''
다익스트라 최단 경로 알고리즘은 여러 개의 노드가 있을 때, 특정한 노드에서 출발하여 다른 노드로 가는 각각의 최단 경로를 구해주는 알고리즘이다. '
다익스트라 최단 경로 알고리즘은 '음의 간선'이 없을 때 정상적으로 동작한다. 또한 다익스트라 최단 경로 알고리즘은 기본적으로 그리기 알고리즘으로 분류된다. 
